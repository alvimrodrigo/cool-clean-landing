...
const FloatingButtons = () => (
  <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
    {/* Botão Telefone */}
    <a
      href="tel:+5571983815959"
      aria-label="Ligar agora"
      className="w-14 h-14 md:w-12 md:h-12 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-2xl hover:scale-110 transition-transform"
      style={{ boxShadow: "0 8px 24px hsl(var(--primary) / 0.5)" }}
    >
    ...
    <a
      ...
      className="w-16 h-16 md:w-14 md:h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl hover:scale-110 transition-transform animate-pulse-slow"
